...
import { LayoutDashboard, Users, Building2, MessageSquare, LogOut, ShieldCheck, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="h-[100dvh] flex flex-col overflow-hidden" style={{ background: "#F5F5F5" }}>
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        {/* Sidebar */}
        <aside className="w-60 shrink-0 flex flex-col overflow-hidden" style={{ background: DARK }}>
