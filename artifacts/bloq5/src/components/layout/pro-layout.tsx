...
import { LayoutDashboard, Building2, MessageSquare, Users, CreditCard, LogOut, UserCircle, UserCheck } from "lucide-react";
    ...
    <>
      <div className="h-[100dvh] flex flex-col overflow-hidden" style={{ background: "#F5F5F5" }}>
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          <aside className="w-64 shrink-0 flex flex-col overflow-hidden" style={{ background: DARK }}>
            ...
            <div className="px-3 pt-4 pb-0 space-y-0.5">
              ...
              >
                ...
                {session ? "Vue client" : "Accès vue client"}
              </button>
      ...
      {showClientModal && (
        <ClientRegisterModal onClose={() => setShowClientModal(false)} />
      )}
    </>
  );
}
